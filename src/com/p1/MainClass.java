...
public class TestFirstProgram {
	...
	public void testDragDrop() {
		...
		String text = driver.findElement(By.xpath("//div[@id='column-a']/header")).getText();
	...
	public void testJsAlert() throws InterruptedException {
		...
		String actualtext = "You entered:Hello";
	...
	public void testFileUpload() throws InterruptedException {
		String path = System.getProperty("user.dir") + File.separator + "demo.rtf";
