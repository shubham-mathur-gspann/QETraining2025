...
//	{
//		
//		String path=System.getProperty("user.dir")+File.separator+"scr.png";
//		System.out.println(path);
//		driver.findElement(By.id("file-upload")).sendKeys(path);
//		driver.findElement(By.id("file-submit")).click();		
//		String uploadedFileName = driver.findElement(By.id("File Uploaded!")).getText();
//	    Assert.assertEquals("scr.png", uploadedFileName);
//
//	}
